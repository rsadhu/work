...
int TestPlugin::thisProperty() const { return m_thisProperty; }
...
QVariant TestPlugin::objectProperty() const { return m_objectProperty; }
...
QList<int> TestPlugin::listIntegers() const { return m_listIntegers; }
