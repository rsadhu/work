...
void
Sorter::BubbleSort (int *arr, uint s)
{
  cout << " \n BubbleSort...\n";
  for (uint i = 0; i < s; i++)
    {
...
void
Sorter::SelectionSort (int *arr, uint s)
{
  cout << "\n Selection Sorting..\n";
  for (uint i = 0; i < s; i++)
    {
...
void
Sorter::InsertionSort (int *arr, uint s)
{
  cout << " \n Insertion Sort....\n";
  for (uint i = 1; i < s; i++)
    {
...
void
Sorter::QuickSort (int *arr, uint s)
{

}

void
Sorter::HeapSort (int *arr, uint s)
{

}

void
Sorter::ShellSort (int *arr, uint s)
{
// to be Implemented
}

void
Sorter::MergeSort (int *arr, uint s)
{
