...
void testSearch() {
  ...
  for (int i = 1; i <= 10; i++)
    std::cout << "\n"
              << i << "    ===== "
              << finder.findItem(i, SEARCH_TYPE::BINARY_TREE_SEARCH_RECU);
  //  std::cout<<"\n item found ::"<<finder.findRecItem(1);

  //    std::cout<<"\n item  4 is :: "<< finder.findItem(4,
  //    SEARCH_TYPE::BINARY_LINEAR_SEARCH_RECU); std::cout<<"\n item  1 is ::
  //    "<< finder.findItem(1, SEARCH_TYPE::BINARY_LINEAR_SEARCH_RECU);
  //    std::cout<<"\n item  10 is :: "<< finder.findItem(10,
  //    SEARCH_TYPE::BINARY_LINEAR_SEARCH_RECU); std::cout<<"\n item  5 is ::
  //    "<< finder.findItem(5, SEARCH_TYPE::BINARY_LINEAR_SEARCH_RECU);
  //    std::cout<<"\n item  6 is :: "<< finder.findItem(6,
  //    SEARCH_TYPE::BINARY_LINEAR_SEARCH_RECU); std::cout<<"\n item  100 is ::
  //    "<< finder.findItem(109, SEARCH_TYPE::BINARY_LINEAR_SEARCH_RECU);
...
minesweeper(std::vector<std::vector<bool>> matrix) {
  std::vector<std::vector<int>> myMat(matrix.size(),
                                      std::vector<int>(matrix.at(0).size(), 0));
