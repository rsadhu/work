...
template <typename U> class MyNode {
public:
...
template <typename T> class Searching {
public:
...
template <typename T> void Searching<T>::createBST(const T &rhs) {
...
template <typename T> bool Searching<T>::findIterItem(const T &rhs) {
...
template <typename T> bool Searching<T>::findRecItem(const T &rhs) {
